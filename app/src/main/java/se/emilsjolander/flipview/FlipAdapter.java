...
public class FlipAdapter extends BaseAdapter implements OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (position % 2 == 0) {
                holder.imageView.setImageDrawable(ContextCompat.getDrawable(holder.imageView.getContext(), R.drawable.burger1));
            } else {
                holder.imageView.setImageDrawable(ContextCompat.getDrawable(holder.imageView.getContext(), R.drawable.latte));
            }
